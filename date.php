...
<body>
  <div class="wrapper">
    <div class="abc"></div>
    <div class="company">
      <div class="log">Welcome &nbsp;<a href="logout.php" class="logout">Logout</a></div>
    </div>
    <div class="time">
      <table border="0">
        <tr>
    ...
    <div class="link">
      <a href="employee.php" class="ab">
        <div class="bar1">Home<img src="../links/main3.png" height="25"></div>
      </a>
      <a href="records.php" class="ab">
        <div class="bar3">Records<img src="../links/edit.png" height="25"></div>
      </a>
    </div>
    <div class="profile">
        ...
        <tr>
          ...
          <td><br />
            <form method="post" action="records.php">
              ...
              <input type="submit" name="save" value="View all" />
            </form>
          </td>
        </tr>
      </table>
    ...
    <div class="body">
      ...
      ?>
        ...
        <table border="0" cellspacing="0" class="pro">
          <tr>
            <td class="td">Employee No.
            <td>:</td>
            </td>
            <td width="50" class="td"><?php echo '<td  class="td" >' . $row['empno'] . '</td>';
                                      ?></td>
            <td width="300" class="td"></td>
            </td>
            <td class="td">Last Name
            <td>:</td>
            </td>
            <td width="50"></td>
            <td><?php echo '<td class="td">' . $row['lname'] . '</td>'; ?></td>
          <tr>
            ...
            <td class="td">First Name
            <td>:</td>
            </td>
            <td></td>
            <td class="td"><?php echo '<td class="td">' . $row['fname'] . '</u></td>'; ?></td>
          </tr>
          <tr>
            ...
            <td class="td">Middle I
            <td>:</td>
            </td>
            <td></td>
            <td class="td"><?php echo '<td class="td">' . $row['init'] . '</td>'; ?></td>
          </tr>
          <tr>
            </p>
          <?php
          ...
          <table border="1" cellspacing=".1" align="center" class="search1" bordercolor="#000000">
            ...
            //$result = mysqli_query($link,"SELECT * FROM emp_info WHERE empno(empno) = empno('$empno')");
