    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_POST['add_'])) {
                ...
                $add_q = mysql_query("INSERT INTO ass_params (name,weight,dept)
                        VALUES('$name','$weight','$dept')") or die(mysql_error());
            ...
            if (isset($_POST['update'])) {
                ...
                $add_q = mysql_query("UPDATE ass_params SET name = '$name',weight='$weight'
            ...
            if (isset($_POST['delete'])) {
                ...
                $add_q = mysql_query("DELETE FROM ass_params WHERE id = '$id' ") or die(mysql_error());
