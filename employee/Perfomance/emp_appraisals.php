        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    ...
                    // Get Emp Group..
                    $grp_q = mysqli_query($link, "SELECT name, id FROM ass_group WHERE empno = '$empno' LIMIT 1 ") or die(mysqli_error($link));
                    $grp_r = mysqli_fetch_array($grp_q);
                    $grp_name = $grp_r['name'];
                    $grp_id = $grp_r['id'];
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($link, "SELECT ass_periods.name AS name, ass_appraisals.id AS id FROM ass_periods
                                                    ...
                                                    WHERE ass_appraisals.ass_group = '$grp_name'
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="view_emp_appraisal.php?app_id=<?php echo $row['id']; ?>" style="color:#fff;" class="btn btn-primary btn-sm">Select</i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
