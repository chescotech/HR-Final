    ...
    if (mysql_num_rows($chekcIfSupervisor) != 0) {
        ...
        echo '<li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="Perfomance/factors"><i class="fa fa-circle-o"></i>Assessment Factors</a></li>
        ...
        echo '<li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="Perfomance/sup_appraisals"><i class="fa fa-circle-o"></i>Submited Appraisals</a></li>
