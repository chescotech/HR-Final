                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            while ($row = mysql_fetch_array($MyLeave)) {
                                                ...
                                                $days = round(abs(strtotime($row['leave_end_date']) - strtotime($row['leave_start_date'])) / 86400);
                                        ...
                                        <tr class="del<?php echo $id_ ?>">
                                            ...
                                            <td style="vertical-align:middle" align="left"><?php echo $row['leave_start_date']; ?></td>
                                            <td style="vertical-align:middle" align="left"><?php echo $row['leave_end_date']; ?></td>
                                            ...
                                            <td style="vertical-align:middle" align="left"><?php
                                                                                            ...
                                                                                            ?></td>
                                            <td style="vertical-align:middle" align="left"><?php
                                                                                            if ($leaveObject->checkIfAttachmentExsists($id_) == "true") {
                                                                                                echo '<a href="view-attachments?application_id=' . $id_ . '" target="blank_"><h4 style="color:#3c8dbc;">attachment</h4></a>';
                                                                                            } else {
                                                                                                echo 'No Attachment';
                                                                                            }
                                                                                            ?>
                                            ...
                                            <td style="vertical-align:middle" align="center" width="100">
                                                <a rel="tooltip" onclick="return confirm('Are you sure you want to appove this leave?')" title="Approve" id="v<?php echo $id_; ?>" <a href="approve_leave.php<?php echo '?id=' . $id_ . "&empEmail=" . $employeeEmail . "&level=" . $currentlevel . " &empno=" . $empNO . "&leave_days=" . $days ?>" class="btn btn-info btn-lg">
                                                    <span class="glyphicon glyphicon-ok-sign"></span>
                                                </a>
                                            </td>
                                            <td style="vertical-align:middle" align="center" width="100">
                                                <a rel="tooltip" onclick="return confirm('Are you sure you want to decline this leave?')" title="Decline" id="v<?php echo $id_; ?>" <a href="decline-leave.php<?php echo '?id=' . $id_ . "&empEmail=" . $employeeEmail . "&empno=" . $empNO . "&leave_days=" . $days ?> " class="btn btn-info btn-lg">
