    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    People on Leave in the <?php echo $leaveObject->getDeptLeaveName($supervisorDepartmentId) . ' Department '; ?>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="#">People on Leave</a></li>
                </ol>
            </section>
