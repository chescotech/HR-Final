                        ...
                        <form enctype="multipart/form-data" method="post">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <center>
                                        <h3 style="color: black" class="box-title">
                                            <b>
                                                Leave Attachment for <?php echo $EmployeeHistoryObject->getEmpInfo($empno) ?>
                                            </b>
                                        </h3>
                                    </center>
                                </div>
                                <div class="box-body">
                                    ...
                                    $certificate = "../../employee/leave-attachments/" . $EmployeeHistoryObject->getLeaveAttachment($application_id);
                                    ?>
