...
class Attendance
{
    ...
    {
        $res = mysqli_query($this->link, "INSERT INTO attendance_logs(log_date,logout_time,empno,company_id,login_time) "
    ...
    {
        $res = mysqli_query($this->link, "UPDATE attendance_logs SET  logout_time = '$logout_time'  WHERE empno = '$empno'"
    ...
    {
        $result = mysqli_query($this->link, "SELECT * FROM company WHERE company_ID = '$company_id' ");
    ...
    public function outOfficeCheckin($empno, $company_id, $log_date, $login_time, $logout_time, $comment)
    {
        $res = mysqli_query($this->link, "INSERT INTO attendance_logs(log_date,logout_time,empno,company_id,login_time,comment,out_office) "
            . "VALUES('$log_date','$logout_time','$empno','$company_id','$login_time','$comment','Yes')");
        return $res;
    }
