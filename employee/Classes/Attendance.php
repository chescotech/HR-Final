...
class Attendance {
    ...
    public function checkInUser($empno, $company_id, $log_date, $login_time, $logout_time) {
        $res = mysql_query("INSERT INTO attendance_logs(log_date,logout_time,empno,company_id,login_time) "
    ...
    public function checkOutUser($empno, $company_id, $logout_time,$log_date) {
        $res = mysql_query("UPDATE attendance_logs SET  logout_time = '$logout_time'  WHERE empno = '$empno'"
    ...
    public function getCompanyLocation($company_id){
         $result = mysql_query("SELECT * FROM company WHERE company_ID = '$company_id' ");
    ...
    public function outOfficeCheckin($empno, $company_id, $log_date, $login_time, $logout_time,$comment) {
        $res = mysql_query("INSERT INTO attendance_logs(log_date,logout_time,empno,company_id,login_time,comment,out_office) "
