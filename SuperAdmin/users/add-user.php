    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            if (isset($_POST['save'])) {
                ...
                $companyObject->adduser($username, $password, $company, $user_type, $fname, $lname, $email);
                            ...
                            <form enctype="multipart/form-data" method="post" >
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">                                            
                                            <input name="fname" placeholder="Enter users first name" class="form-control" >
                                        </div>                                        
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">                                            
                                            <input name="lname" placeholder="Enter Last name" class="form-control" >
                                        </div>                                         
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">                                            
                                            <input name="email" placeholder="Enter users email" id="datepicker" class="form-control" >
                                        </div>                                       
                                    </div>
