                    ...
                    <div class="col-md-3">
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                <?php
                                $id = $_GET['id'];
                                $user_query = mysqli_query($link, "SELECT * FROM company where company_ID='$id'") or die(mysqli_error($link));
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary btn-block"><b>
                                            ...
                                            <?php
                                            $result = mysqli_query($link, "SELECT * FROM company where company_ID='$id'") or die(mysqli_error($link));
