                            ...
                            <link href="src/css/bootstrap.css" rel="stylesheet">
                                ...
                                <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
                                    ...
                                    <style type="text/css">
                                        ...
                                        .se{margin-left:20px;}
                                        input[type=button], input.button { width:200px; background:white;  #999; color:#CCC; font-weight:bold; margin-top:15px; cursor:pointer; width:200px; -moz-border-radius:5px; -webkit-border-radius:5px; padding:4px;
                                    ...
                                    <body>
                                        ...
                                        <div class="profile5">
                                            ...
                                            <form method="post" action="search.php">
                                                <center><table  cellpadding=""  border="0" class="se">
                                                        <tr>
                                                            <td>
...
//-------------------------------------------search----------------------------------//
                                                        if (isset($_POST["key"])) {
                                                            ...
                                                            while ($row = mysql_fetch_array($result2, MYSQL_ASSOC)) {
                                                                ...
                                                                <br/><br/>
                                                                <div class="">
                                                                    <table border="0" class="tb" align="center" cellspacing="0"><td>

                                                                        </td><td>
                                                                            <div class="a" > <legend><table border="" align="center"cellspacing="0" style="border:gray 1px solid"><td><?php
  ...
  ' . $row['position'] . '</td>'; ?></td>
                                                                                        <td></td><td  class="font_info">Middle Initial:<td>:</td></td>
