...
if (isset($_POST["create_posting"])) {
    ...
    mysqli_query($link, "INSERT INTO jobs_postings (title, dep_id, type, vacancies, salary_min, salary_max, experience, date, expires, salary_period, qualifications, status, currency, country, region, city, description, requirements, reg_number)
                                            VALUES('$title', '$dep_id', '$type', '$vacancies', '$salary_min', '$salary_max', '$experience', '$date', '$expires', '$salary_period', '$qualifications','Unpublished','$currency','$country','$region','$city','$description','$requirements', $reg_number)")
...
<div class="content-wrapper" style="overflow:auto; height:80vh">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active">Create new job</li>
        </ol>
    </div>
        ...
        <form method="POST">
            ...
            <div class="panel panel-default">
                ...
                <div style="background-color:#fff; border-radius:5px; padding:10px; margin-bottom:20px;">
                    <label>
                        Fill out required information and publish your job.
                    </label>
                    ...
                    <div>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="expires" required>
                            </div>
                    ...
                    <div>
                        <div action="#save" class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description" class="form-control" rows="9" required></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="pwd">Job requirements:</label>
                                <textarea name="requirements" class="form-control" rows="9" required></textarea>
                            </div>
            ...
            <div class="panel panel-default">
                ...
                <div style="padding:10px; margin-top:20px;">
                    <div>
                        <div action="#save" class="row g-3">
                            <div class="col-md-6">
                                <button name="create_posting" onclick="error_message()" type="submit" class="btn btn-primary btn-block btn-flat">Create Job</button>
                            </div>
                        </div>
                    </div>
                </div>
