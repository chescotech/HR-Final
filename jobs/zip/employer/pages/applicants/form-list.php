...
<div class="content-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-body" style="font-size:14px;">
            ...
            <div>
                <a href="shortlisted?job=" class="btn btn-primary">Shortlisted Candidates</a>
                <br>
            </div>
            ...
            <table id="maintable" class="display compact cell-border" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    if (isset($_GET['job'])) {
                        ...
                        $filter_by_job = " WHERE jobs_postings.reg_number != '' ";
                        if ($job_rn != "all") {
                            $filter_by_job = " WHERE jobs_postings.reg_number=jobs_user_applications.reg_number";
                        }
                    }
                    $user_q = mysqli_query($link, "SELECT jobs_user_applications.jobs_job_id AS job_id,jobs_user_applications.reg_number,talent_pool.title,fname,lname, jobs_postings.title as job,
                        ...
                        WHERE jobs_postings.reg_number=jobs_user_applications.reg_number AND jobs_postings.reg_number = '$reg_num'
                        $sort_by_date            
                    ...
                    ?>
                        ...
                        <tr class="<?php echo $cls ?>">
                            ...
                            echo '
                                ...
                                <td>
                                    <a class="btn btn-primary" style="padding:2px; padding-left: 10px; padding-right:10px;" target="_blank" href="preview.php?user_id=' . $appcant_user_id . '">View Applicant</a>
                                    <button type="button" class="btn btn-primary label" data-toggle="modal" data-target="#meeting' . $id . '">
                                    Meeting
                                </button>

                                <a href="interviews.php?user_id=' . $appcant_user_id . '" class="btn btn-primary label" >
                                    Interview
                                </a>
