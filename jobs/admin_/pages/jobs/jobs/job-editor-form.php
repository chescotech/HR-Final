...
if (isset($_POST["updated_posting"])) {
    ...
    mysqli_query($link, "UPDATE jobs_postings SET title='$title', dep_id='$dep_id', type='$type', vacancies='$vacancies', salary_min='$salary_min', salary_max='$salary_max', experience='$experience', date='$date', expires='$expires', salary_period='$salary_period', qualifications='$qualifications', currency='$currency', country='$country', region='$region', city='$city', description='$description', requirements='$requirements' WHERE id='$from_jobs_id'")
