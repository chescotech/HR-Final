...
class EmployeeHistory
{
    ...
    {
        $res = mysqli_query($link, "INSERT INTO emp_edu_info_tb (emp_id,highest_qualifications,qualifications,university,secondary_school) "
    ...
    {
        $result = mysqli_query($link, "UPDATE emp_edu_info_tb SET highest_qualifications ='$highest_qualification',"
    ...
    {
        $res = mysqli_query($link, "SELECT * FROM emp_edu_info_tb where emp_id='$empno'");
        return $res;
    }

    public function checkCertificates($empno)
    {
        $res = mysqli_query($link, "SELECT * FROM certificates_tb where empno='$empno'");
        return $res;
    }

    public function getHistoryInfo($empno)
    {
        $res = mysqli_query($link, "SELECT * FROM emp_history_tb where emp_id='$empno'");
        return $res;
    }
    ...
    public function addEmpHistInfo(
        ...
        $res = mysqli_query($link, "INSERT INTO emp_history_tb (emp_id,
                ...
                '$employer_four','$position_four','$date_start_four','$date_end_four',
                '$employer_five','$position_five','$date_start_five' ,'$date_end_five',
                'Pending')") or die("error adding: " . mysqli_error($link));
    ...
    public function updateEmpHistInfo(
        ...
        $result = mysqli_query($link, "UPDATE emp_history_tb SET 
    ...
    public function updateCertificate($empno, $CV, $Qualification)
    {
        ...
        $result = mysqli_query($link, "UPDATE certificates_tb SET cv ='$CV',"
    ...
    {
        $res = mysqli_query($link, " SELECT * FROM leave_applications_tb where application_id='$empno' ");
        $rows = mysqli_fetch_array($res);
        $cv = $rows['file_proof'];
        return $cv;
    }
