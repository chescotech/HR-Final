...
$sql = "SELECT reason_for_exit, COUNT(*) AS 'count' FROM employee_exits_tb WHERE empno IN ( SELECT empno FROM emp_info WHERE company_id = '$companyId' ) GROUP BY reason_for_exit ";
...
$graph->title->Set("Employee exits by reason");
...
$p1->midtitle->Set("Employee exits \n by reason");
