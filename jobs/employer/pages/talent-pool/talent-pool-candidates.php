            ...
            <div class="panel panel-default">
                <div class="panel-body" style="font-size:14px;">
                    ...
                    <table id="maintable" class="display compact cell-border" cellspacing="0" width="100%">
                        ...
                        WHERE talent_pool.id='$pool_id' AND jobs_user_applications.emp_id = $comp_id");
                            ...
                            <tr>
                                ...
                                <td>' . $talent_pool . '</td>
                                <td>
                                <a class="btn btn-primary" style="padding:2px; padding-left: 10px; padding-right:10px;" href="/jobs/employer/pages/applicants/preview.php?user_id=' . $appcant_user_id . '">View Candidate</a>
