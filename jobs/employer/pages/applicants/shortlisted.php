                    ...
                    <table id="maintable" class="display compact cell-border" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <form method="POST" action="#save">
                                ...
                                $quer = mysqli_query($link, "SELECT jobs_user_applications.jobs_job_id AS job_id,jobs_user_applications.emp_id,talent_pool.title,fname,lname, jobs_postings.title as job,
