<?php
// $reg_number = strval($_SESSION['reg_num']);
...
if (isset($_POST["create_posting"])) {
    ...
    $show_salary = $_POST["show_salary"] ? $_POST["show_salary"] : 'false';
                    ...
                    <div>
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="show_salary" id="show_salary" value="false" onchange="handleCheck()">
