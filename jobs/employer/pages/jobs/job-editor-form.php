...
if (isset($_GET['id'])) {
    ...
    while ($row = mysql_fetch_array($user_q)) {
        ...
        $edit_show_salary = $row['show_salary'];
        ...
        $edit_requirements = $row["requirements"];
    }
}
...
if (isset($_POST["updated_posting"])) {
    ...
    echo '<script>
        ...
        function showPopupMessage(message, redirectUrl) {
            ...
            }, 3000); // Adjust the time in milliseconds (3 seconds in this example)
        }

        // Call the function to display the pop-up message and redirect
        showPopupMessage("Update successful", "job-list.php");
                    ...
                    <div>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="<?php echo date('Y-m-d', strtotime($edit_date)); ?>" type="text" class="form-control" name="date" required>
                            </div>

                            <div class="col-md-6">
                                <label for="expires">Last Date to Apply:</label>
                ...
                <div style="background-color:#fff; border-radius:5px; padding:10px; margin-top:20px;">
                    ...
                    <div>
                        <div class="form-check">
                            <input type="hidden" name="show_salary" value="false">
                            <input class="form-check-input" type="checkbox" name="show_salary" id="show_salary" value="true" onchange="handleCheck()" <?php echo $edit_show_salary ? 'check' : ''; ?>>
                            <label for="show_salary" class="form-check-label">Show salary scale?</label>
                        </div>
                    ...
                    <div>
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select id="country" name="country" class="form-control" value="<?php echo $edit_country; ?>">
                    ...
                    <div>
                        <div action="#save" class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea style="padding:15px" name="description" class="form-control" rows="9" required><?php echo $edit_description; ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="pwd">Job requirements:</label>
                                <textarea style="padding:15px" name="requirements" class="form-control" rows="9" required><?php echo $edit_requirements; ?></textarea>
                            </div>
...
<script>
    function handleCheck() {
        const check = document.getElementById('show_salary');
        check.checked ? check.value = true : check.value = false;
    }
</script>