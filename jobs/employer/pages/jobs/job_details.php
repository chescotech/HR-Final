...
<body class="layout-h">
    <div class="wrapper">
        ...
        <?php
        include_once("../../navigation_panel/dbconnection.php");
        $id_ = $_GET['job'];
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <blockquote style="font-size: 12px">
                                        <div class="job_des" style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif, solaimanlipi;">
                                            ...
                                            <textarea style="padding:10px; align-text:justify; border: 0px;" readonly id="" cols="80" rows="15"><?php echo $description; ?></textarea>
                                        </div>
                                        ...
                                        <div class="job_req" style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif, solaimanlipi;">
                                            ...
                                            <div class=""> <textarea readonly style="padding:10px; border: 0px; border: 0px;" cols="80" rows="15"><?php echo $requirements; ?></textarea> </div>
                                        </div>
                                    </blockquote>
                                </div>
