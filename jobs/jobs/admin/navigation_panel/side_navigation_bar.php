    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="../Payslips/add-casual-paylslip"><i class="fa fa-circle-o"></i>Add Casual Pay slip</a></li>
                    ...
                    <li><a href="../Payslips_old/download-payslip.php"><i class="fa fa-circle-o"></i>Download Pay Slip</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="../reports/payroll-expense-by-dept"><i class="fa fa-circle-o"></i>Payroll expense by Department</a></li>
                    <li><a href="../reports/payroll-expense-summary"><i class="fa fa-circle-o"></i>Payroll expense Summary</a></li>
                    ...
                    <li><a href="../reports/nhema-report"><i class="fa fa-circle-o"></i>NHEMA Report</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
