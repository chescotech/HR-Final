        ...
        <center>
            <form name=calc method=POST>
                <table width="60%" border="1">
                    ...
                    <tr>
                        <td>Loan Amount</td>
                        <td align=right><input class="form-control" type=text name=loan size=10></td>
                    </tr>
                    <tr>
                        <td>Loan Length in Months</td>
                        <td align=right>
                            <input class="form-control" type=text name=months size=10>
                        </td>
                    </tr>
                    <tr>
                        <td>Interest Rate</td>
                        <td align=right><input class="form-control" type=text name=rate size=10></td>
                    </tr>
                    <tr>
                        <td>Monthly Payment</td>
                        <td align=right>
                            <input class="form-control" type=text name=pay size=10>
                        </td>
                    </tr>
                    <tr>
                        <td align=center>
