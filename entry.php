...
//echo "Tax paid on $starting_income is 
                                                                    ...
                                                                    $result = mysql_query($query6) or die($query . "<br/><br/>" . mysql_error());
                                                                    $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                                                    ...
                                                                    if ($insert) {
                                                                        ...
                                                                        $checkIfEmployeeExsist = mysql_query($checkQuery) or die($checkQuery . "<br/><br/>" . mysql_error());

                                                                        if (mysql_num_rows($checkIfEmployeeExsist) == 0) {
                                                                            mysql_query("INSERT INTO tax (taxable_to_date,tax_paid_to_date,empno,company_id,social)"
                                                                                            . "VALUES ('$taxable','$total_tax_paid','$empno','$comp_ID','0') ")or die(mysql_error());
                                                                        } else {
                                                                            mysql_query("UPDATE tax SET taxable_to_date = taxable_to_date + $taxable , tax_paid_to_date = tax_paid_to_date + $total_tax_paid WHERE empno = '$empno'")or die(mysql_error());
                                                                        }
                                                                        $checkForLeave = "SELECT * FROM leave_days where empno='$empno'";
                                                                        $checkIfEmployeeLeaveExsist = mysql_query($checkForLeave) or die($checkForLeave . "<br/><br/>" . mysql_error());

                                                                        if (mysql_num_rows($checkIfEmployeeLeaveExsist) == 0) {
                                                                            mysql_query("INSERT INTO leave_days (available,empno)"
                                                                                            . "VALUES ('2','$empno') ")or die(mysql_error());
                                                                        } else {
                                                                            mysql_query("UPDATE leave_days SET available = available + 2 WHERE empno = '$empno'")or die(mysql_error());
                                                                        }
                                                                    ...
                                                                    $result4 = mysql_query($query4, $link) or die("invali query" . mysql_error());
                                                                    echo '</center>';
                                                                }
                                                            }
                                                        }
                ...
                ';
                                                                    ...
                                                                    <style type="text/css">
                                                                    ...
                                                                    </style>  <fieldset class="a" > <legend>Payslip Entry</legend>
                                                                        <?php echo '<strong>' . $msg . '</strong>'; ?><form method="post" action="entry.php" onSubmit="return proceed()" class="form">
                                                                            ...
                                                                            <table border="0" cellspacing="0" align="center"  " class="form" >
                                                                                ...
                                                                                $query = mysql_query("select * from emp_info WHERE company_ID = '$company_id' ") or die(mysql_error());
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input class="form-control" type="text" name="dayswork" value="<?php echo $dayswork; ?>" tabindex="13" title="Enter Number"onFocus="if (this.value == '0') {
                                                                                                this.value = '';
                                                                                            }" onBlur="if (this.value == '0')" {this.value = '0';} /></td></tr>
                                                                                <tr>
