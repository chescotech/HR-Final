...
$reportDate = $_POST['napsa_date_report'];
                    ...
                    <link href="src/css/color/default.css" rel="stylesheet" media="screen">
                        ...
                        <link href="src/css/bootstrap.css" rel="stylesheet">
                            ...
                            <body>
                                ...
                                <script type="text/javascript"> document.write('' + Date() + '')</script></strong>
                                <div class="profile5">

                                    <strong>NAPSA REPORT FOR PERIOD <?php echo $month ?> 2016</strong>
                                    ...
                                    <div class="body">                                        
                                        <table class="responstable">
                                            <tr bgcolor="gray">
                                                ...
                                                <tr>
                                                    <?php
                                                    $query = "SELECT em.id, em.otrate, em.empno, em.pay, em.dayswork, em.othrs, em.allow, n.fname, n.lname, em.advances, em.insurance, em.time, em.company_id, t.social
