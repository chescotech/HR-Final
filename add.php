...
<body>
    ...
    $resource = mysqli_query($link, $sql) or die("username heck error");
    ...
    <form method="post" action="add.php" onSubmit="return proceed()">
        ...
        ?>
            ...
            $resource = mysqli_query($link, $sql) or die("username check error");
            if (isset($_POST['insert'])) {
        ...
        <center>
            <fieldset class="a">
                ...
                <table cellspacing="10">
                    ...
                    <tr>
                        <td>Firstname</td>
                        <td align="center"><input class="form-control" type="text" class="style1" name="fname" value="<?php echo $fname; ?>" tabindex="3" /></td>
                    </tr>
                    <tr>
                        <td>Initial</td>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <select name="employee_grade" class="form-control">
                                ...
                                <?php
                                $query = mysqli_query($link, "SELECT grade FROM grade where company_ID = '$comp_ID' ") or die(mysqli_error($link));
                                while ($row = mysqli_fetch_array($query)) {
                                ?>
