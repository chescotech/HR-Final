                    ...
                    <div class="col-md-9">
                        ...
                        <form enctype="multipart/form-data" method="post">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <center>
                                        <h3 style="color: black" class="box-title">
                                            <b>
                                                Certificate Information for <?php echo $EmployeeHistoryObject->getEmpInfo($empno) ?>
                                            </b>
                                        </h3>
                                    </center>
                                </div>
                                <div class="box-body">
                                    <?php
                                    $cv = "../../employee/uploads/" . $EmployeeHistoryObject->getCerttificates($empno);
                                    ?>
                                    <embed src="<?php echo $cv; ?>" width="100%" height="1100px" />
                                </div>
                            </div>
                        </form>
                    </div>
