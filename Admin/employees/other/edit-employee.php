                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body" hidden="hidden">
                                        ...
                                        <div class="form-group">
                                            <input required="required" value="<?php echo $rows['empno']; ?>" name="empno" class="form-control" placeholder="Enter First Name:">
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-horizontal">
                                            <input value="<?php echo $rows['basic_pay']; ?>" required="required" name="basic_pay" class="form-control" placeholder="Gross Pay">
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-horizontal">
                                            <input value="<?php echo $allowanceRows['house_allowance']; ?>" required="required" type="number" name="house_allowance" class="form-control" placeholder="Enter House Allowance">
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-horizontal">
                                            <input value="<?php echo $allowanceRows['transport_allowance']; ?>" required="required" type="number" name="transport_allowance" class="form-control" placeholder="Enter Transport Allowance">
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-horizontal">
                                            <input value="<?php echo $allowanceRows['lunch_allowance']; ?>" required="required" type="number" name="lunch_allowance" class="form-control" placeholder="Enter Lunch Allowance">
                                        </div>
                                    </div>
