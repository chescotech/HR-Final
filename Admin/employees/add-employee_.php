...
<body class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
        ...
        if (isset($_POST['save'])) {
            ...
            $message = " Dear " . $fname . " , Welcome to " . $CompanyName . "." . "<br>" . "<br>"
                . "Your Employee ID is " . "$empno"
                . ", login to :  http://212.71.251.244/crystalpay/PayrollHr/ using your "
                . " employee ID as your username and password = ctl@2020 . "
                . " PLease change this password upon Login . " . "<br>" . "<br>" . "<br>" . "<br>"
                . $image;
                        ...
                        <form enctype="multipart/form-data" method="post">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-horizontal">
                                        <input required="required" onkeypress="return onlyAlphabets(event, this);" name="bank_name" class="form-control" placeholder="Bank Name">
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-horizontal">
                                        <input required="required" id="numeric" name="gross_pay" class="form-control" placeholder="Gross Pay">
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-horizontal">
                                        <input required="required" onkeypress="return onlyAlphabets(event, this);" name="payment_method" class="form-control" placeholder="Cash Or Bank Transfer">
                                    </div>
                                </div>
