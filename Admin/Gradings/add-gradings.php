...
<body class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
        ...
        if (isset($_POST['save_post'])) {
            ...
            $DepartmentObject->addEmployeeGrade($employee_grade, $minimum_pay, $maximum_pay, $comp_ID);
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    if (isset($_POST['save_post'])) {
                                        ...
                                        echo ' <center>
                                            <h3 style="color: black" class="box-title"><b>Add Employee Grading</b></h3>
                                        </center>';
                                    }
                                    ?>
                                </div>
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input required="required" name="employee_grade" class="form-control" placeholder="Enter Employee Grade:">
                                    </div>
                                    <div class="form-group">
                                        <h5 style="color: black"><b>Minimum Pay</b></h5>
                                        <input required="required" name="minimum_pay" class="form-control" placeholder="Enter Minimum Pay:">
                                    </div>

                                    <div class="form-group">
                                        <h5 style="color: black"><b>Maximum Pay</b></h5>
                                        <input required="required" name="maximum_pay" class="form-control" placeholder="Enter Maximum Pay:">
                                    </div>
