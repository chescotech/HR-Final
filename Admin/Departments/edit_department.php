...
<body class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
        ...
        if (isset($_POST['update_post'])) {
            ...
            $id = $_GET['id'];
            $DepartmentObject->UpdateDepartment($department, $id);
                                ...
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        ...
                                        if (isset($_POST['update_post'])) {
                                            ...
                                            echo ' <center>
                                            <h3 style="color: black" class="box-title"><b>Edit Department</b></h3>
                                        </center>';
                                        }
                                        ?>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <h5>Department Name:</h5><input name="department" value="<?php echo $rows['department']; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="box-body">
