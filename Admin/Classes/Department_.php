...
class Department
{
    ...
    public function addEmployee(
        ...
        $res = mysqli_query($this->link, "INSERT emp_info(empno,fname,lname,init,gender
    ...
    {
        $result = mysqli_query($this->link, "INSERT INTO appover_groups(work_flow_id,level,empno) VALUES('$workflow_id','$level','$empno')");
        return $result;
    }
