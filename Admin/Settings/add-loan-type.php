...
<body class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
        ...
        if (isset($_POST['save_post'])) {
            ...
            $LoanObject->addLoanType($loan_type, $max_repayment_period, $approver_email, $comp_ID);
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-3">
                        <a href="loan-types" class="btn btn-primary btn-block margin-bottom">Back</a>
                    </div>
                    <div class="col-md-5">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    if (isset($_POST['save_post'])) {
                                        ...
                                        echo ' <center>
                                            <h3 style="color: black" class="box-title"><b>Add Loan Type</b></h3>
                                        </center>';
                                    }
                                    ?>
                                </div>
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input required="required" name="loan_type" class="form-control" placeholder="Enter Loan Type:">
                                    </div>

                                    <div class="form-group">
                                        <h5 style="color: black"><b>Maximum Repayment Period</b></h5>
                                        <input required="required" name="max_repayment_period" class="form-control" placeholder="Enter Maximum Number of months:">
                                    </div>

                                    <div class="form-group">
                                        <h5 style="color: black"><b>Approver Email</b></h5>
                                        <input required="required" name="approver_email" type="email" class="form-control" placeholder="Enter the approver email:">
                                    </div>
