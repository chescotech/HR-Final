            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body">
                                <center><img src="get-payroll-expenses-by-dept.php" /></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12">
                                ...
                                <table id="employee_data" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysql_fetch_array($query)) {
                                            ...
                                            $sum += $payrollAmountByDept;
                                            echo '  
                                                <tr>  
                                                    <td>' . $departmentName . '</td>  
                                                    <td> K ' . number_format($payrollAmountByDept) . '</td>                                                          
                                                </tr>  
                                                ';
                                        }
                                        ?>
