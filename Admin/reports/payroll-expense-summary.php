                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                echo '  
                                                        <tr>  
                                                            <td>Overtime</td>  
                                                            <td>' . number_format($overtimeTotal, 2) . '</td>
                                                            <td></td>                                                    
                                                        </tr> 
                                                        ';
                                                echo '  
                                                ...
                                                echo '  
                                                        <tr>  
                                                            <td>PAYE</td>  
                                                            <td></td>
                                                            <td>' . number_format($payeTotal, 2) . '</td>                                                    
                                                        </tr> 
                                                        ';
                                                echo '  
                                                        <tr>  
                                                ...
                                                echo '  
                                                        <tr>  
                                                            ...
                                                            <td></td>
                                                            <td>' . number_format($salaryAdvanceTotal, 2) . '</td>                                                    
                                                        </tr> 
                                                        ';
                                                echo '  
                                                        <tr>  
                                                ...
                                                echo '  
                                                        <tr>  
                                                            <td>Net Pay</td>  
                                                            <td></td>
                                                            <td>' . number_format($netPayTotal, 2) . '</td>                                                    
                                                        </tr> 
                                                        ';
                                                echo '  
                                                        <tr>  
                                                ...
                                                echo '  
                                                        <tr>  
                                                            ...
                                                            <td>' . number_format($creditTotal + $overtimeTotal, 2) . '</td>                                                    
                                                        </tr> 
                                                        ';
                                            }
                                            ?>
