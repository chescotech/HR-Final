    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_POST['add_holiday'])) {
                $name = $_POST['name'];
                $full_date = $_POST['date'];

                $date = substr_replace($full_date, "*", 0, 4);
                ...
                if ($add_q) {
                    ...
                    echo "<script> window.location='holidays' </script>";
                }
            }
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" action="#update" enctype='multipart/form-data'>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name">Holiday Desc</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        <input type="date" class="form-control" id="name" name="date" value="<?php echo $row['date']; ?>" required>
                                                                    </div>
                                                                </div>
                                                        </div>
                                ...
                                <form method="post" action="#add_holiday" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <button class="btn btn-primary" id="daterange-btn" name="add_holiday">
                                                Save
                                            </button>
