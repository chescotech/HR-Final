...
<ul class="sidebar-menu">
    ...
    <li class="treeview" <?php echo $permissions['company_setup'] == 'false' ? 'hidden' : '' ?>>
        ...
        <ul class="treeview-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="Company/manage-assets"><i class="fa fa-user-plus"></i>Assets</a></li>
    ...
    <li class="treeview" <?php echo $permissions['payroll'] == 'false' ? 'hidden' : '' ?>>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="recurring-deductions/view"><i class="fa fa-circle-o"></i>Add Recurring Deduction</a></li>
            <li><a href="recurring-deductions/create"><i class="fa fa-circle-o"></i>View Recurring Deductions</a></li>
    ...
    <li class="treeview" <?php echo $permissions['reports'] == 'false' ? 'hidden' : '' ?>>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="reports/employee-retirement-report"><i class="fa fa-circle-o"></i>Retirement Report</a></li>
