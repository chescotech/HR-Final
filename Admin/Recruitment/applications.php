                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="employee_data" class="table table-striped table-bordered">
                                        ...
                                        while ($row = mysql_fetch_array($result)) {
                                            ...
                                            $pathCV = "../../files/covers/" . $cv;
                                            $pathCover = "../../files/covers/" . $cover;

                                            // check if the CV was uploaded///
                                            if (file_exists($pathCV) && $cv != "") {
                                                $cvLink = '<a href="../../files/cv/' . $cv . '">Download </a>';
                                            } else {
                                                $cvLink = 'No File Uploaded';
                                            }

                                            // check if the cover letter was uploaded..

                                            if (file_exists($pathCover) && $cover != "") {
                                                $coverLink = '<a href="../../files/covers/' . $cover . '">Download </a>';
                                            } else {
                                                $coverLink = 'No File Uploaded';
                                            }
