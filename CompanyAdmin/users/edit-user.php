                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <center>
                                        <?php
                                        $id = $_GET['id'];
                                        $Query = mysqli_query($link, " SELECT * FROM users_tb WHERE id = '$id' ");
                                    ...
                                    <div class="form-group">
                                        <select name="company" class="form-control">
                                            <option value="<?php echo $rows['company_id']; ?>"><?php
                                                                                                ...
                                                                                                $companyQuery = mysqli_query($link, "SELECT * FROM company where company_ID = '$compnayId'");
                                                                                                $companyRow = mysqli_fetch_array($companyQuery);
