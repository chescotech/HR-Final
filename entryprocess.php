        ...
        <div class="body1">
          ...
          <?php echo '<strong>' . $msg . '</strong>'; ?><form method="post" action="entryprocess.php" onSubmit="return proceed()" class="form">
            ...
            <table border="0" cellspacing="0" align="center" " class=" form">
              ...
              <tr>
                <td>Days worked</td>
                <td><input type="text" name="dayswork" value="<?php echo $dayswork; ?>" tabindex="13" title="Enter Number" onFocus="if (this.value == '0') {this.value = '';}" onBlur="if (this.value == '0')" {this.value='0' ;} /></td>
              </tr>
              ...
              <center>
                <td align="center"><select name="bmonth" tabindex="7" class="bmonth">
                  ...
                  <input type="text" name="byear" value="<?php echo $byear; ?>" size="4" maxlength="4" tabindex="9" id="byear" onFocus="if (this.value == 'YYYY') {this.value = '';}" onBlur="if (this.value == 'YYYY')" {this.value='YYYY' ;} />
                </td>
              </center>
              </tr>
              <tr>
